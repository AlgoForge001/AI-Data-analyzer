...
const Sidebar = () => {
    return (
        <div className="w-[220px] h-screen bg-gradient-to-b from-[#080b12] to-black border-r border-white/5 flex flex-col p-6 fixed left-0 top-0 z-20">
            ...
            <nav className="flex-1 space-y-2">
                ...
                <SidebarItem icon={Upload} label="Upload Data" active />
                <SidebarItem icon={BarChart3} label="Analysis" />
                <SidebarItem icon={History} label="Executions" />
            </nav>
